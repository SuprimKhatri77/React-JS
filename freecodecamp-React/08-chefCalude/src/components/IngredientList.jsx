      ...
      {ingredients.length > 0 ? (
        <section className="max-w-[582px] mx-auto mt-5">
          ...
          {ingredients.length >= 4 ? (
            <div
              ref={ref}
              className="flex flex-col md:flex-row md:justify-between gap-2 bg-gray-200 py-5 px-7 mt-5 md:mt-8 rounded-md items-center"
            >
              ...
              <button
                className="bg-orange-700 animation cursor-pointer py-2 px-5 rounded-full hover:bg-orange-800  text-white   transition-all duration-300 ease-in-out"
                onClick={getRecipe}
              >
                Get a recipe
              </button>
